...
Comprehensive memory management overhaul for better performance with large codebases and long-running processes. Particularly beneficial when using Repoxide as a library in applications that process multiple repositories.
