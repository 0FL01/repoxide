This release brings comprehensive JSON output format support with jq integration, making Repoxide more efficient and versatile for AI analysis!
...
```bash
# Extract file list
cat repoxide-output.json | jq -r '.files | keys[]'

# Get specific file content
cat repoxide-output.json | jq -r '.files["src/index.js"]'
```
...
For detailed JSON format documentation and more examples, see: https://repoxide.com/guide/output#json-format

## Improvements ⚡

### CLI Help Text Enhancement (#831)
Improved CLI help text clarity and accuracy with corrected default values and better descriptions, making it easier for AI agents to handle Repoxide more accurately when assisting users.
