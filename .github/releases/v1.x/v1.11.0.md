This release introduces the `--split-output` option for splitting large packed outputs into multiple files, making Repoxide more practical for AI tools with file size limits!
...
repoxide --split-output 1mb

# Larger chunks for bigger context windows
repoxide --split-output 20mb

# With decimal values
repoxide --split-output 1.5mb
```

This generates numbered files like:
- `repoxide-output.1.xml`
- `repoxide-output.2.xml`
- `repoxide-output.3.xml`
