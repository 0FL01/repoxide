...
- Added `--stdout` option for CLI output  
  - Provides more flexibility for integrating Repoxide in scripts and pipelines
    ```bash
    # Send output to stdout, then pipe into another command (for example, simonw/llm)
    repoxide --stdout | llm "Please explain what this code does."
    ```

### GitHub Actions Support (#510, #528)
- Added GitHub Action for integrating Repoxide into CI/CD workflows  

See full usage at [repoxide.com/guide/github-actions](https://repoxide.com/guide/github-actions).
