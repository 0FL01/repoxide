...
- Added new `--quiet` option:
  ...
  - Perfect for programmatic usage when using Repoxide as a library
...
For more details on remote repository features, see [Remote Repository Processing](https://github.com/yamadashy/repoxide?tab=readme-ov-file#remote-repository-processing).

# Documentation 📚

## Documentation (#344, #345)
- Added [German translation](https://repoxide.com/de/) for website
