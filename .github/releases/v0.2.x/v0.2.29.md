...
- Added support for uploading ZIP files directly through the web interface (https://repoxide.com/)
...
- Added additional exports to support using Repoxide as a library
