This release introduces new CLI flags to provide users with more control over the structure and content of Repoxide output.
...
```bash
docker run -v .:/app -it --rm ghcr.io/yamadashy/repoxide:0.2.12
```

---
We appreciate your feedback and contributions to make Repoxide even better!
