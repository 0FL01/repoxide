...
- **client**: The frontend web application.
  - Exposed Port: `83` (mapped to internal port `5173`)
  - Environment: `NODE_ENV=development`
  - Volume: Mounts `./website/client` for development.

- **server**: The backend API service.
  - Internal Port: `8080` (not exposed to host by default)
  - Environment: `NODE_ENV=development`
  - Volume: Mounts `./website/server` for development.
