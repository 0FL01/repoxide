...
const SKILL_NAME_PREFIX = 'repoxide-reference';
 ...
 * Examples:
 * - https://github.com/yamadashy/repoxide → repoxide
 * - https://github.com/yamadashy/repoxide/ → repoxide
 * - yamadashy/repoxide → repoxide
 * - git@github.com:yamadashy/repoxide.git → repoxide
 */
 ...
 * Returns: repoxide-reference-<repo-name>
 */
 ...
 * Returns: repoxide-reference-<folder-name>
 */
