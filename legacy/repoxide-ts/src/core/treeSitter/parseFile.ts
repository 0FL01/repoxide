...
// TODO: Do something with config: RepoxideConfigMerged, it is not used (yet)
export const parseFile = async (fileContent: string, filePath: string, config: RepoxideConfigMerged) => {
