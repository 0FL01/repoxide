...
const generateSkillInputSchema = z.object({
  ...
  skillName: z
    ...
    .optional()
    .describe(
      'Name of the skill to generate (kebab-case, max 64 chars). Will be normalized if not in kebab-case. Used for the skill directory name and SKILL.md metadata. If omitted, auto-generates as "repoxide-reference-<folder-name>".',
    ),
  compress: z
    .boolean()
    .default(false)
...
Example Path:
  /path/to/project/.claude/skills/repoxide-reference-myproject/`,
