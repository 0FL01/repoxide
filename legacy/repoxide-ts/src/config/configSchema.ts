...
// Output style enum
export const repoxideOutputStyleSchema = z.enum(['xml', 'markdown', 'json', 'plain']);
export type RepoxideOutputStyle = z.infer<typeof repoxideOutputStyleSchema>;

// Default values map
export const defaultFilePathMap: Record<RepoxideOutputStyle, string> = {
  xml: 'repoxide-output.xml',
  markdown: 'repoxide-output.md',
  plain: 'repoxide-output.txt',
  json: 'repoxide-output.json',
} as const;

// Base config schema
export const repoxideConfigBaseSchema = z.object({
  ...
  output: z
    .object({
      ...
      style: repoxideOutputStyleSchema.optional(),
...
export const repoxideConfigDefaultSchema = z.object({
  input: z.object({
    maxFileSize: z
      .number()
      .int()
  ...
  output: z.object({
    ...
    style: repoxideOutputStyleSchema.default('xml'),
...
export const repoxideConfigFileSchema = repoxideConfigBaseSchema;

// CLI-specific schema. Add options for standard output mode and skill generation
export const repoxideConfigCliSchema = repoxideConfigBaseSchema.and(
  z.object({
    output: z
      .object({
...
export const repoxideConfigMergedSchema = repoxideConfigDefaultSchema
  .and(repoxideConfigFileSchema)
  .and(repoxideConfigCliSchema)
  .and(
    z.object({
      cwd: z.string(),
    }),
...
export type RepoxideConfigDefault = z.infer<typeof repoxideConfigDefaultSchema>;
export type RepoxideConfigFile = z.infer<typeof repoxideConfigFileSchema>;
export type RepoxideConfigCli = z.infer<typeof repoxideConfigCliSchema>;
export type RepoxideConfigMerged = z.infer<typeof repoxideConfigMergedSchema>;
...
export const defaultConfig = repoxideConfigDefaultSchema.parse({
  input: {},
  output: {
    git: {},
  },
...
export const defineConfig = (config: RepoxideConfigFile): RepoxideConfigFile => config;
