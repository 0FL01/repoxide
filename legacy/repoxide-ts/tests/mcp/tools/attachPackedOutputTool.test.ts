...
describe('AttachPackedOutputTool', () => {
  ...
  test('should handle XML file path input', async () => {
    const testFilePath = '/test/repoxide-output.xml';
  ...
  test('should handle directory path input', async () => {
    ...
    const expectedXmlPath = '/test/project/repoxide-output.xml';
  ...
  test('should handle directory without repoxide-output.xml', async () => {
  ...
  test('should handle malformed XML by returning zero metrics', async () => {
    const testFilePath = '/test/repoxide-output.xml';
    const malformedXml = '<repoxide><file path="test.js">unclosed tag</repoxide>';
  ...
  test('should handle Markdown file path input', async () => {
    const testFilePath = '/test/repoxide-output.md';
...
\`\`\`
  ...
  test('should handle Plain text file path input', async () => {
    const testFilePath = '/test/repoxide-output.txt';
    const plainContent = `
================
File: src/index.js
================
...
function helper() {}
  ...
  test('should handle JSON file path input', async () => {
    const testFilePath = '/test/repoxide-output.json';
