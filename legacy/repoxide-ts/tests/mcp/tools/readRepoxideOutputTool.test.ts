...
import { registerReadRepoxideOutputTool } from '../../../src/mcp/tools/readRepoxideOutputTool.js';
...
describe('readRepoxideOutputTool', () => {
  const mockMcpServer = {
    registerTool: vi.fn(),
  } as const;
  ...
  beforeEach(() => {
    ...
    registerReadRepoxideOutputTool(mockMcpServer as unknown as McpServer);
