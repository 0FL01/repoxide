...
import {
  ...
  formatSearchResults,
  performGrepSearch,
  registerGrepRepoxideOutputTool,
  searchInContent,
} from '../../../src/mcp/tools/grepRepoxideOutputTool.js';
...
describe('grepRepoxideOutputTool', () => {
  ...
  describe('registerGrepRepoxideOutputTool integration tests', () => {
    const mockMcpServer = {
      registerTool: vi.fn(),
    } as const;
    ...
    beforeEach(() => {
      ...
      registerGrepRepoxideOutputTool(mockMcpServer as unknown as McpServer);
