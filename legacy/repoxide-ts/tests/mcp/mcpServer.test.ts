...
describe('MCP Server', () => {
  ...
  describe('createMcpServer', () => {
    test('should create server with correct configuration', async () => {
      ...
      expect(McpServer).toHaveBeenCalledWith(
        ...
        {
          instructions: expect.stringContaining('Repoxide MCP Server provides AI-optimized codebase analysis tools'),
        },
      );
  ...
  describe('runMcpServer', () => {
    test('should connect server with stdio transport', async () => {
      ...
      expect(logger.trace).toHaveBeenCalledWith('Repoxide MCP Server running on stdio');
    });
    ...
    test('should handle SIGINT signal', async () => {
      ...
      expect(logger.trace).toHaveBeenCalledWith('Repoxide MCP Server shutdown complete');
