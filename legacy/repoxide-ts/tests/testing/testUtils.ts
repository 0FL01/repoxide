...
import { defaultConfig, type RepoxideConfigMerged } from '../../src/config/configSchema.js';
...
export const createMockConfig = (config: DeepPartial<RepoxideConfigMerged> = {}): RepoxideConfigMerged => {
  return {
