...
describe('writeSkillOutput', () => {
  ...
  test('should throw RepoxideError with permission message on EPERM error', async () => {
    const mockMkdir = vi.fn().mockResolvedValue(undefined);
    ...
    await expect(promise).rejects.toThrow(RepoxideError);
    await expect(promise).rejects.toThrow(/Permission denied/);
  });

  test('should throw RepoxideError with permission message on EACCES error', async () => {
    const mockMkdir = vi.fn().mockResolvedValue(undefined);
  ...
  test('should throw RepoxideError with generic message on other errors', async () => {
    const mockMkdir = vi.fn().mockResolvedValue(undefined);
