...
describe('remoteAction functions', () => {
  ...
  describe('parseGitHubRepoInfo', () => {
    test('should parse GitHub shorthand', () => {
      const result = parseGitHubRepoInfo('yamadashy/repoxide');
    ...
    test('should parse GitHub URL with branch', () => {
      const result = parseGitHubRepoInfo('https://github.com/yamadashy/repoxide/tree/develop');
      expect(result).toEqual({
        owner: 'yamadashy',
        repo: 'repoxide',
        ref: 'develop',
    ...
    test('should parse GitHub git URL', () => {
      const result = parseGitHubRepoInfo('https://github.com/yamadashy/repoxide.git');
      expect(result).toEqual({
        owner: 'yamadashy',
        repo: 'repoxide',
      });
    ...
    test('should handle git@ URLs', () => {
      const result = parseGitHubRepoInfo('git@github.com:yamadashy/repoxide.git');
      expect(result).toEqual({
        owner: 'yamadashy',
        repo: 'repoxide',
      });
    ...
    test('should merge branch from parsing when URL contains branch info', () => {
      const result = parseGitHubRepoInfo('https://github.com/yamadashy/repoxide/tree/feature/test');
      expect(result).toEqual({
        owner: 'yamadashy',
        repo: 'repoxide',
        ref: 'feature/test',
  ...
  describe('isGitHubRepository', () => {
    test('should return true for GitHub repositories', () => {
      expect(isGitHubRepository('yamadashy/repoxide')).toBe(true);
      expect(isGitHubRepository('https://github.com/yamadashy/repoxide')).toBe(true);
      expect(isGitHubRepository('git@github.com:yamadashy/repoxide.git')).toBe(true);
      expect(isGitHubRepository('https://github.com/yamadashy/repoxide/tree/develop')).toBe(true);
    });
