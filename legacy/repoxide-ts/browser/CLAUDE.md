...
This file provides guidance for working with the Repoxide browser extension.

## Project Overview

Cross-browser extension (Chrome/Firefox/Edge) that adds Repoxide integration to GitHub repository pages. Uses Manifest V3 with content scripts to inject a "Repoxide" button directly into GitHub's UI.
