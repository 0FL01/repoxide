...
A browser extension that adds a Repoxide button to GitHub repository pages.

## 🚀 Features

- Adds a "Repoxide" button to GitHub repository pages
- One-click redirect to Repoxide (https://repoxide.com)
...
3. A "Repoxide" button will appear in the page header action area
4. Click the button to open the repository in Repoxide
