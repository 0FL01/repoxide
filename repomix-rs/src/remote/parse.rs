...
mod tests {
    ...
    fn test_valid_shorthand() {
        ...
        assert!(is_valid_shorthand("yamadashy/repomix"));
    ...
    fn test_parse_shorthand() {
        let info = parse_remote_url("yamadashy/repomix").unwrap();
        assert_eq!(info.owner, "yamadashy");
        assert_eq!(info.repo, "repomix");
        assert_eq!(info.url, "https://github.com/yamadashy/repomix.git");
