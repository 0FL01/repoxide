...
mod tests {
    ...
    fn test_default_config() {
        let config = RepoxideConfig::default();
    ...
    fn test_serialize_config() {
        ...
        assert!(json.contains("repoxide-output.xml"));
    }
    ...
    fn test_deserialize_config() {
        ...
        let config: RepoxideConfig = serde_json::from_str(json).unwrap();
